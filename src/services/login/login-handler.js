...
import { ServerErrorResponse } from '../../model/response/server-error-response.js'
...
export function postLogin(req, res) {
    try {
        ...
        const msg = new ServerErrorResponse(err.message)
        res.status(statusCode.SERVER_ERROR).send(msg)
        return
    }
